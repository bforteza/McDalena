...
Coordinador::Coordinador(GLdouble _ancho, GLdouble _alto) :
	...
	Menu.add_boton(new BotonEnclavado(100, 100, -240, -240, "bin/imagenes/NoMute.png", "bin/imagenes/MuteAzul.png", "bin/imagenes/Mute.png", std::bind(&Coordinador::set_mute, this)));
	...
	speedchess.add_boton(new BotonEnclavado(100, 100, -240, -260, "bin/imagenes/NoMute.png", "bin/imagenes/MuteAzul.png", "bin/imagenes/Mute.png", std::bind(&Coordinador::set_mute, this)));
	...
	unicopeon.add_boton(new BotonEnclavado(100, 100, -240, -260, "bin/imagenes/NoMute.png", "bin/imagenes/MuteAzul.png", "bin/imagenes/Mute.png", std::bind(&Coordinador::set_mute, this)));
	...
	MenuMusica.add_boton(new BotonEnclavado(100, 100, 260, 260, "bin/imagenes/NoMute.png","bin/imagenes/MuteAzul.png", "bin/imagenes/Mute.png", std::bind(&Coordinador::set_mute, this)));
	...
	Integrantes.add_boton(new BotonEnclavado(100, 100, 260, 260, "bin/imagenes/NoMute.png", "bin/imagenes/MuteAzul.png", "bin/imagenes/Mute.png", nullptr));
	
Integrantes.add_boton(new BotonEnclavado(100, 100, 260, 260, "bin/imagenes/NoMute.png", "bin/imagenes/MuteAzul.png", "bin/imagenes/Mute.png", std::bind(&Coordinador::set_mute, this)));
 }